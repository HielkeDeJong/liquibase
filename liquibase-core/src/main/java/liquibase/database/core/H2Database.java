...
public class H2Database extends AbstractJdbcDatabase {
	...
	public String getViewDefinition(CatalogAndSchema schema, String name) throws DatabaseException {
		...
		definition = definition.replaceFirst("/\\*.*", ""); // sometimes
															// includes comments
															// at the end
		return definition;
	}
	...
	public Date parseDate(String dateAsString) throws DateParseException {
		System.out.println("parseDate" + dateAsString);
		try {
	...
	public boolean isSafeToRunUpdate() throws DatabaseException {
		...
		boolean isLocalURL = (super.isSafeToRunUpdate() || url.startsWith("jdbc:h2:file:")
	...
	// return
	// super.convertRequestedSchemaToSchema(requestedSchema).toLowerCase();
	// }
	...
	private static List keywords = Arrays.asList("CROSS", "CURRENT_DATE", "CURRENT_TIME", "CURRENT_TIMESTAMP",
			"DISTINCT", "EXCEPT", "EXISTS", "FALSE", "FOR", "FROM", "FULL", "GROUP", "HAVING", "INNER", "INTERSECT",
			"IS", "JOIN", "LIKE", "LIMIT", "MINUS", "NATURAL", "NOT", "NULL", "ON", "ORDER", "PRIMARY", "ROWNUM",
